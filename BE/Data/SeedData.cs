...
public static class SeedData
{
    ...
    {
        // Ensure Category column exists (Manual Migration Helper)
        try
        {
            // Only try to add if it's MySQL/MariaDB
        ...
        catch { /* Ignore - column might already exist or DB might not support IF NOT EXISTS */ }
